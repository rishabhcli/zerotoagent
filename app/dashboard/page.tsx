...
export default async function DashboardPage() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 liquid-glass rounded-[24px] p-8 relative overflow-hidden">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="liquid-glass-subtle rounded-[24px] p-6">
      ...
      {runs.length === 0 ? (
        <div className="liquid-glass-subtle rounded-[24px] p-12 text-center flex flex-col items-center justify-center min-h-[400px]">
          <div className="w-20 h-20 bg-primary/10 rounded-full flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(var(--primary),0.08)]">
        ...
        <div className="liquid-glass rounded-[24px] overflow-hidden">
          <div className="p-6 border-b border-white/[0.08] bg-white/[0.03]">
